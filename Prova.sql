...
CREATE TABLE IF NOT EXISTS APOLICES(
    ...
    CONSTRAINT FK_CARROS_APOLICES FOREIGN KEY (APO_CAR) REFERENCES CARROS (CAR_REGISTRO)
);
...
CREATE TABLE IF NOT EXISTS ACIDENTES(
    ...
    CONSTRAINT FK_CARROS_ACIDENTES FOREIGN KEY (ACI_CAR) REFERENCES CARROS (CAR_REGISTRO)
);

CREATE TABLE IF NOT EXISTS CLIENTES_CARROS(
    CLCR_CLIENTES INT NOT NULL,
    CLCR_CARROS INT NOT NULL,
    PRIMARY KEY (CLCR_CLIENTES, CLCR_CARROS),
    CONSTRAINT CLCR_FK_CLIENTES FOREIGN KEY (CLCR_CLIENTES) REFERENCES CLIENTES(CLI_NUM),
